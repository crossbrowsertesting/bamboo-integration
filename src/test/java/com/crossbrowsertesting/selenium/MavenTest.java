...
public class MavenTest {
    static String username = System.getenv("bamboo_CBT_USERNAME"); // Your username
    static String authkey = System.getenv("bamboo_CBT_AUTHKEY");  // Your authkey
    ...
    public void setup() throws MalformedURLException {
        ...
        caps.setCapability("name", "Bamboo Test");
